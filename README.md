...
This project builds upon the foundational Grid-based Coverage Planning theories presented in the paper **"Online Concurrent Multi-Robot Coverage Path Planning"** (Ratijit Mitra1 and Indranil Saha2).
...
| **Center drop** | `10,10; 10,11; 11,10` |**Mission Abort** | Algorithmic Livelock (Boundary Reached) |
...
* **OS:** Ubuntu 24.04
* **Middleware:** ROS 2 (Compatible with your Ubuntu distribution)
