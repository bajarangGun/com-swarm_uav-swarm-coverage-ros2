...
void MUNKRES_ALGO::zstar(int_mat cost_mat, bool_mat &zstar_mat, bool_vec &has_zstar_row, bool_vec &has_zstar_col, vec_int &zstar_row_col, vec_int &zstar_col_row, uint row_count, uint col_count)
{
	for(uint i = 0; i < row_count; i++)
		for(uint j = 0; j < col_count; j++)
...
vec_int MUNKRES_ALGO::assign(int_mat cost_mat, bool_mat zstar_mat, uint row_count, uint col_count)
{
...
vec_int MUNKRES_ALGO::munkres(int_mat cost_mat, uint row_count, uint col_count)
{
